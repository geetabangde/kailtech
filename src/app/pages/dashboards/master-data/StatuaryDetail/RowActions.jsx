...
//     try {
//       // Static delete - sirf UI se hata raha hoon
...
//         <Button
//           onClick={() =>
//             navigate("/dashboards/master-data/statuary-detail/edit")
//           }
          
//           className="size-9 rounded-full hover:bg-gray-100 dark:hover:bg-dark-600 transition-colors"
...
//           className="size-9 rounded-full text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 transition-colors"
