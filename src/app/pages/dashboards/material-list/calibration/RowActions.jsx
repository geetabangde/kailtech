...
export function RowActions({ row, table }) {
  ...
  const actions = [
    // View Equipment History
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/calibration/view-equipment-history/${row.original.id}`
        ),
    },
      ...
      ? [
          {
            ...
            onClick: () =>
              navigate(
                `/dashboards/material-list/calibration/Edit/${row.original.id}`
              ),
          },
        ]
      : []),
    ...
    // Maintenance Equipment History
    {
      ...
      onClick: () =>
        navigate(
                  `/dashboards/material-list/calibration/maintenance-equipment-history`   
        ),
    },
    ...
    // View Checklist
    {
      ...
      onClick: () =>
        navigate(
                  `/dashboards/material-list/calibration/view-checklist/${row.original.id}`   
        ),
    },
    ...
    // View Verification List
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/calibration/view-verification-list/${row.original.id}`
        ),
    },
    ...
    // Dump
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/calibration/dump/${row.original.id}`
        ),
    },
    ...
    // Log Book
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/calibration/log-book/${row.original.id}`
        ),
    },
