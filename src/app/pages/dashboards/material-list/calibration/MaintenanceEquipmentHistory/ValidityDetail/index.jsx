...
//     onClick={() =>
//       navigate(
//         "/dashboards/material-list/calibration/maintenance-equipment-history/add-new-equipment-history"
//       )
//     }
//   >
      ...
      <div className="flex items-center justify-between space-x-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button
            ...
            onClick={() =>
              navigate(
                "/dashboards/material-list/calibration/maintenance-equipment-history/validity-detail/add-new-master-matrix"
              )
            }
          >
            Add New Master Matrix
      ...
      <div className="flex flex-col pt-4 space-y-6">
        ...
        >
          <div className="flex justify-between items-center mb-4">
            ...
            onClick={() =>
              navigate(
                "/dashboards/material-list/calibration/maintenance-equipment-history/validity-detail/add-new-uncertinity-matrix"
              )
            }>
