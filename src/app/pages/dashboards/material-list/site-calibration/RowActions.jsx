...
export function RowActions({ row, table }) {
  ...
  const actions = [
    // View Equipment History
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/site-calibration/view-equipment-history/${row.original.id}`
        ),
    },
      ...
      ? [
          {
            ...
            onClick: () =>
              navigate(
                `/dashboards/material-list/site-calibration/Edit/${row.original.id}`
              ),
          },
        ]
      : []),
    ...
    // View Checklist
    {
      ...
      onClick: () =>
        navigate(
                  `/dashboards/material-list/site-calibration/view-checklist/${row.original.id}`   
        ),
    },
    ...
    // View Verification List
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/site-calibration/view-verification-list/${row.original.id}`
        ),
    },
    ...
    // Dump
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/site-calibration/dump/${row.original.id}`
        ),
    },
    ...
    // Log Book
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/site-calibration/log-book/${row.original.id}`
        ),
    },
