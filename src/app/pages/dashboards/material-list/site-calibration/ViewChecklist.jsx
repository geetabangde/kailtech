      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex space-x-2">
            ...
            <Button className=" text-white px-4 py-2 rounded bg-indigo-500 hover:bg-fuchsia-500"
             onClick={() =>
              navigate("/dashboards/material-list/site-calibration/add-new-master-matrix")
            }>
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <Button className="bg-indigo-500 hover:bg-fuchsia-500 text-white px-4 py-2 rounded "
                onClick={() =>
                    navigate("/dashboards/material-list/site-calibration/add-new-general-checklist-matrix")
                  }>
