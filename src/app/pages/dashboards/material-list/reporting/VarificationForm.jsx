...
// import ProductVerificationSheet from './ProductVerificationSheet'; // Import the new component

// // Original ProductVerificationSheet list component
// const ProductVerificationList = ({ onBackClick }) => {
...
//           onClick={() => navigate("/dashboards/material-list/reporting")}
//         >
...
//   const [currentView, setCurrentView] = useState('form'); // 'form', 'list', or 'verification-sheet'
...
//   const handleShowVerificationSheet = () => {
//     setCurrentView('verification-sheet');
//   };
...
//   // Show Product Verification Sheet (the new form from screenshot)
//   if (currentView === 'verification-sheet') {
//     return <ProductVerificationSheet onBackClick={handleBackToList} />;
//   }

//   // Show Product Verification List
//   if (currentView === 'list') {
//     return <ProductVerificationList onBackClick={handleShowVerificationSheet} />;
//   }
