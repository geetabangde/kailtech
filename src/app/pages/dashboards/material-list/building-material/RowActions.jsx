...
export function RowActions({ row, table }) {
  ...
  const actions = [
    // View Equipment History
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/building-material/view-equipment-history/${row.original.id}`
        ),
    },
      ...
      ? [
          {
            ...
            onClick: () =>
              navigate(
                `/dashboards/material-list/building-material/Edit/${row.original.id}`
              ),
          },
        ]
      : []),
    ...
    // View Checklist
    {
      ...
      onClick: () =>
        navigate(
                  `/dashboards/material-list/building-material/view-checklist/${row.original.id}`   
        ),
    },
    ...
    // View Verification List
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/building-material/view-verification-list/${row.original.id}`
        ),
    },
    ...
    // Dump
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/building-material/dump/${row.original.id}`
        ),
    },
    ...
    // Log Book
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/building-material/log-book/${row.original.id}`
        ),
    },
