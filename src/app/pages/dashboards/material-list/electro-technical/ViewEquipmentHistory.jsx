...
// export default function ViewEquipmentHistory() {
//   const handleBackToList = () => {
...
//           {/* Department, Site Calibration, EQPT ID Section */}
//           <div className="p-4">
...
//                   <tbody>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50 w-32">Name of Instrument:</td>
//                       <td className="px-3 py-2">Electrosurgery Analyzer</td>
//                     </tr>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Make:</td>
//                       <td className="px-3 py-2">Fluke</td>
//                     </tr>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Model:</td>
//                       <td className="px-3 py-2">QA-ES MKIII</td>
//                     </tr>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">S.No.:</td>
//                       <td className="px-3 py-2">4837012</td>
//                     </tr>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Date of installation:</td>
//                       <td className="px-3 py-2">05/09/2020</td>
//                     </tr>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Location of Equipment:</td>
//                       <td className="px-3 py-2"></td>
//                     </tr>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Name & Contact details of Service Provider:</td>
//                       <td className="px-3 py-2 text-xs">Life Force 207, Second Floor, Plot No.-51 Hasanpur, Delhi-110092 Mr. Vijay Sharma</td>
//                     </tr>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">WI Reference:</td>
//                       <td className="px-3 py-2">KTRC-CAL(BM)-SOP-07</td>
//                     </tr>
//                     <tr>
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Software / Firmware details:</td>
//                       <td className="px-3 py-2">-</td>
//                     </tr>
//                   </tbody>
//                 </table>
...
//               <div className="w-1/3 border-r border-gray-400">
//                 <div className="bg-gray-200 px-3 py-2 border-b border-gray-400">
//                   <span className="font-semibold text-xs">SITE CALIBRATION</span>
//                 </div>
//                 <table className="w-full text-xs">
//                   <tbody>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Range:</td>
//                       <td className="px-3 py-2">As Per Manual</td>
//                     </tr>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">L.C.:</td>
//                       <td className="px-3 py-2">As Per Range</td>
//                     </tr>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Accuracy:</td>
//                       <td className="px-3 py-2">As Per Manual</td>
//                     </tr>
//                     <tr className="border-b border-gray-400">
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Acceptance Criteria:</td>
//                       <td className="px-3 py-2 text-xs">
//                         <div>Error with in the accuracy</div>
//                         <div className="text-gray-600">(KTRC/QF/0704/07)</div>
//                       </td>
//                     </tr>
//                     <tr>
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Equipment Conforms Specified Requirement:</td>
//                       <td className="px-3 py-2">Yes/No</td>
//                     </tr>
//                   </tbody>
//                 </table>
//               </div>
...
//               <div className="w-1/3">
//                 <div className="bg-gray-200 px-3 py-2 border-b border-gray-400">
//                   <span className="font-semibold text-xs">EQPT ID: KTRC-BM-EQ-007</span>
//                 </div>
//                 <table className="w-full text-xs">
//                   <tbody>
//                     <tr className="border-b border-gray-400">
...
//                     </tr>
//                     <tr>
//                       <td className="px-3 py-2 font-medium border-r border-gray-400 bg-gray-50">Equipment Conforms:</td>
//                       <td className="px-3 py-2">Yes/No</td>
//                     </tr>
//                   </tbody>
//                 </table>
...
//                   <th className="border border-gray-300 px-3 py-2 text-left font-semibold">TYPE OF SERVICE</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 <tr>
...
//               <thead>
//                 <tr className="bg-gray-100">
//                   <th className="border border-gray-300 px-2 py-2 text-left font-semibold">CODE</th>
//                   <th className="border border-gray-300 px-2 py-2 text-left font-semibold">IMPLEMENT DATE</th>
//                   <th className="border border-gray-300 px-2 py-2 text-left font-semibold">NEXT DUE DATE</th>
//                   <th className="border border-gray-300 px-2 py-2 text-left font-semibold">RESULT OF CALIBRATION</th>
//                   <th className="border border-gray-300 px-2 py-2 text-left font-semibold">ADJUSTMENTS</th>
//                   <th className="border border-gray-300 px-2 py-2 text-left font-semibold">MEETS CRITERIA</th>
//                   <th className="border border-gray-300 px-2 py-2 text-left font-semibold">SIGNED BY</th>
...
//           {/* Signature Section */}
//           <div className="p-4 pt-8 flex justify-end space-x-24">
//             <div className="text-center">
//               <div className="text-xs font-medium mb-12">DTM</div>
//               <div className="border-b border-gray-400 w-24"></div>
//               <div className="text-xs mt-2">Name</div>
//             </div>
//             <div className="text-center">
//               <div className="border-b border-gray-400 w-24 mb-12"></div>
