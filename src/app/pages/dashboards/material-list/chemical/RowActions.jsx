...
export function RowActions({ row, table }) {
  ...
  const actions = [
    // View Equipment History
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/chemical/view-equipment-history/${row.original.id}`
        ),
    },
      ...
      ? [
          {
            ...
            onClick: () =>
              navigate(
                `/dashboards/material-list/chemical/Edit/${row.original.id}`
              ),
          },
        ]
      : []),
    ...
    // Maintenance Equipment History
    {
      ...
      onClick: () =>
        navigate(
                  `/dashboards/material-list/chemical/maintenance-equipment-history/${row.original.id}`   
        ),
    },
    ...
    // View Checklist
    {
      ...
      onClick: () =>
        navigate(
                  `/dashboards/material-list/chemical/view-checklist/${row.original.id}`   
        ),
    },
    ...
    // View Verification List
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/chemical/view-verification-list/${row.original.id}`
        ),
    },
    ...
    // Dump
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/chemical/dump/${row.original.id}`
        ),
    },
    ...
    // Log Book
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/chemical/log-book/${row.original.id}`
        ),
    },
