...
//     onClick: () =>
//       navigate(
//         `/dashboards/material-list/building-material/maintenance-equipment-history/view-review-form`
//       ),
//   },
//     {
//     label: "Change File",
...
//     onClick: () =>
//       navigate(
//         `/dashboards/material-list/building-material/maintenance-equipment-history/change-file/${row.original.id}`
//       ),
//   },
//   {
...
//     onClick: () =>
//       navigate(
//         `/dashboards/material-list/building-material/maintenance-equipment-history/view-certificate/${row.original.id}`
//       ),
//   },
//   {
...
//     onClick: () =>
//       navigate(
//         `/dashboards/material-list/building-material/maintenance-equipment-history/validity-detail/${row.original.id}`
//       ),
//   },
//   {
//     label: "Edit Validity",
...
//     onClick: () =>
//       navigate(
//         `/dashboards/material-list/building-material/maintenance-equipment-history/edit-validity/${row.original.id}`
//       ),
//   },
//   {
//     label: "Add IMC",
...
//     onClick: () =>
//       navigate(
//         `/dashboards/material-list/building-material/maintenance-equipment-history/add-imc/${row.original.id}`
//       ),
//   },
//   {
...
//     onClick: () =>
//       navigate(
//         `/dashboards/material-list/building-material/maintenance-equipment-history/clone-certificate-details/${row.original.id}`
//       ),
//   },
...
export function RowActions({ row, table }) {
  ...
  const actions = [
    ...
    },
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/building-material/maintenance-equipment-history/validity-detail`
        ),
    },
    {
      label: "Edit Validity",
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/building-material/maintenance-equipment-history/edit-validity`
        ),
    },
    {
      label: "Add IMC",
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/building-material/maintenance-equipment-history/add-imc`
        ),
    },
    {
      label: "Clone Certificate Details",
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/building-material/maintenance-equipment-history/clone-certificate-details`
        ),
    },
    // Delete - This will be at the bottom with different styling
    {
