...
export function RowActions({ row, table }) {
  ...
  const actions = [
    // View Equipment History
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/calibration-mechanical/view-equipment-history`
        ),
    },
    ...
    ...(row.original.status === -1
      ? [
          {
            ...
            onClick: () =>
              navigate(
                `/dashboards/material-list/calibration-mechanical/Edit`
              ),
          },
        ]
      : []),
      ...
      onClick: () =>
        navigate(
                  `/dashboards/material-list/calibration-mechanical/Edit/${row.original.id}`   
     ),
    },
    // Maintenance Equipment History
    {
      ...
      onClick: () =>
        navigate(
                  `/dashboards/material-list/calibration-mechanical/maintenance-equipment-history`   
        ),
    },
    ...
    // View Checklist
    {
      ...
      onClick: () =>
        navigate(
                  `/dashboards/material-list/calibration-mechanical/view-checklist/${row.original.id}`   
        ),
    },
    ...
    // View Verification List
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/calibration-mechanical/view-verification-list/${row.original.id}`
        ),
    },
    ...
    // Dump
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/calibration-mechanical/dump/${row.original.id}`
        ),
    },
    ...
    // Log Book
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/calibration-mechanical/log-book/${row.original.id}`
        ),
    },
