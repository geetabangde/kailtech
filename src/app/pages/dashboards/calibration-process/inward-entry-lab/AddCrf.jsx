...
//     adjustment: 'No',
//     adjustmentremark: '',
//     modeofdispatch: '', // Added modeofdispatch field
//   });
...
//   const addMatrixDetail = () => {
//     // Get the first matrix entry data to pre-populate
//     const firstEntry = matrixEntries.length > 0 ? matrixEntries[0] : null;
...
//         matrixId: firstEntry?.matrixId || null,
//         pricematrixid: firstEntry?.pricematrixId || null,
//         calibPoints: [],
//       },
//     ]);
//   };
...
//         operangemin: matrixDetails.map(d => d.operatingRangeMin || ''),
//         operangemax: matrixDetails.map(d => d.operatingRangeMax || ''),
//         leastcount: matrixDetails.map(d => d.leastCount || ''),
//         mode: matrixDetails.map(d => d.mode || ''),
