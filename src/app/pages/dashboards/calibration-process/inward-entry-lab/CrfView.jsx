      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Button
            ...
            onClick={() =>(window.location.href = `/dashboards/calibration-process/inward-entry-lab`)}
          >
            Back Inward Entry lab List
         ...
         <table className="w-full h-full text-xs text-gray-800 border-l border-gray-300 border-collapse">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border text-xs text-gray-800 mb-4">
              <thead className="bg-gray-100">
                <tr>
                  {["S. No.", "UUC NAME, MAKE/MODEL", "SR/ID.NO.", "PARAMETER", "RANGE, LEAST COUNT", "INSTRUMENT LOCATION", "VALIDITY, IF REQUIRED", "REMARK"].map((head) => (
          ...
          <div>
            ...
            <table className="w-full border text-sm mb-4">
              ...
              <tbody>
                {[
                  ["Is the condition of DUC ok for Calibration?", technical.DUCCalibration],
                  ["Is the capability & resources available?", technical.resourcesavailable],
                  ["Is all the terms & conditions discussed with the customer?", technical.discussedcustomer],
                  ["Is there any specific requirement?", technical.specificrequirement],
                  ["Accessories, if any?", technical.Accessories],
                ].map(([q, v], idx) => (
                  <tr key={idx}>
                    <td className="p-2 border">{idx + 1}</td>
          ...
          <table className="w-full border border-gray-300 text-sm mt-8">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="p-2 font-semibold">{signature.name}</td>
              </tr>
              <tr>
                <th className="p-2 text-left border-r border-gray-300">Date</th>
                <td className="p-2 text-black-800">{signature.date}</td>
              </tr>
            </tbody>
          </table>
          </div>
