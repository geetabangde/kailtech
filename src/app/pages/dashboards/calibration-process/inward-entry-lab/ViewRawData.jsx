      ...
      try {
        ...
        if (reportData?.success === true && reportData?.data) {
          ...
          if (uuc_details) {
            ...
            if (reportData.data.standards && Array.isArray(reportData.data.standards)) {
            ...
            const mappedEquipmentData = {
              ...
              inwarddate: reportData.data.inwardEntry?.inwarddate || "N/A",
              ...
              calibratedon: reportData.data.instrument?.calibratedon || "N/A",
              suggestedDueDate: reportData.data.instrument?.duedate || "N/A",
    ...
    <>
      ...
      <div className="p-6 bg-white text-sm">
        ...
        <div className="flex items-center justify-between mb-4 no-print">
          <h2 className="text-lg font-semibold text-gray-800">View Raw Data - Calibration Report</h2>
          <Button
            variant="outline"
          ...
          {Object.keys(thermalCoeff).length > 0 && (
            <div className="mb-6 p-4 bg-gray-50 rounded">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                {thermalCoeff.uuc && <p><b>UUC Thermal Coefficient:</b> {thermalCoeff.uuc}</p>}
                {thermalCoeff.master && <p><b>Master Thermal Coefficient:</b> {thermalCoeff.master}</p>}
                {thermalCoeff.thickness_of_graduation && <p><b>Thickness of Graduation:</b> {thermalCoeff.thickness_of_graduation}</p>}
              </div>
            </div>
          )}
            ...
            <table className="w-full border border-gray-300 text-sm">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="border border-gray-300 px-3 py-2 text-left">S.w/o</th>
                  <th className="border border-gray-300 px-3 py-2 text-left">LD No.</th>
                ...
                {masterData.length > 0 ? (
                  masterData.map((master, index) => (
                    <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className="border border-gray-300 px-3 py-2">{master.serialno}</td>
                      ...
                      <td className="border border-gray-300 px-3 py-2">{master.enddate}</td>
                    </tr>
                  ))
                ) : (
                  <tr>
