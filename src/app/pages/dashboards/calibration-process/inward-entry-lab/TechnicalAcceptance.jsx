...
export default function AddTechnicalAcceptance() {
  ...
  const caliblocation = queryParams.get("caliblocation") || "Lab";
  const calibacc = queryParams.get("calibacc") || "Nabl";
    ...
    <Page title="Technical Acceptance">
      <div className="p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {sampleEntryBy && (
            <div className="mb-4 space-y-2 rounded border bg-gray-100 p-3">
              <div>
