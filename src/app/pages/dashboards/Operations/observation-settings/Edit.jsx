...
//     { id: 1, checked: false, fieldname: 'S. No.', fieldHeading: '', fieldPosition: '1' },
//     { id: 2, checked: true, fieldname: 'Setpoint', fieldHeading: 'Set Point UUC', fieldPosition: '2' },
//     { id: 3, checked: false, fieldname: 'Setpoint("C")', fieldHeading: '', fieldPosition: '' },
//     { id: 4, checked: false, fieldname: 'Range', fieldHeading: '', fieldPosition: '' },
//     { id: 5, checked: false, fieldname: 'Unit', fieldHeading: '', fieldPosition: '' },
//     { id: 6, checked: false, fieldname: 'Sensitivity Co efficient', fieldHeading: '', fieldPosition: '3' },
//     { id: 7, checked: false, fieldname: '', fieldHeading: '', fieldPosition: '5' },
//     { id: 8, checked: false, fieldname: '', fieldHeading: '', fieldPosition: '6' },
//     { id: 9, checked: false, fieldname: '', fieldHeading: '', fieldPosition: '' },
//   ]);

//   const [rows2, setRows2] = useState([
//     { id: 1, checked: true, fieldname: 'Observation 1', fieldHeading: 'M1' },
//     { id: 2, checked: true, fieldname: 'Observation 2', fieldHeading: 'M2' },
//     { id: 3, checked: true, fieldname: 'Observation 3', fieldHeading: 'M3' },
//     { id: 4, checked: false, fieldname: 'Observation 4', fieldHeading: '' },
//     { id: 5, checked: false, fieldname: 'Observation 5', fieldHeading: '' },
//     { id: 6, checked: false, fieldname: 'Observation 6', fieldHeading: '' },
//     { id: 7, checked: false, fieldname: '', fieldHeading: '' },
//   ]);
...
//   const handleSave = () => {
//     console.log('Table 1 Data:', rows1);
//     console.log('Table 2 Data:', rows2);
...
//             <h1 className="text-2xl font-bold text-gray-800">Field Configuration</h1>
//           </div>
...
//                 <tr>
//                   <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 border-b border-gray-300">S. No.</th>
//                   <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 border-b border-gray-300">Checkbox</th>
//                   <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 border-b border-gray-300">Fieldname</th>
//                   <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 border-b border-gray-300">Field Heading</th>
//                   <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 border-b border-gray-300">Field Position</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {rows1.map((row) => (
...
//                             onChange={() => {
//                               setRows1(rows1.map(r => r.id === row.id ? { ...r, checked: false } : r));
//                             }}
//                             className="w-4 h-4 text-blue-600 focus:ring-2 focus:ring-blue-500"
//                           />
...
//                         type="text"
//                         value={row.fieldname}
//                         onChange={(e) => handleInputChange1(row.id, 'fieldname', e.target.value)}
...
//         <div className="bg-white rounded-lg shadow-md overflow-hidden">
//           <div className="p-4 border-b border-gray-200">
//             <h1 className="text-2xl font-bold text-gray-800">Observation Configuration</h1>
//           </div>
...
//                             checked={row.checked === false}
//                             onChange={() => {
//                               setRows2(rows2.map(r => r.id === row.id ? { ...r, checked: false } : r));
//                             }}
//                             className="w-4 h-4 text-blue-600 focus:ring-2 focus:ring-blue-500"
//                           />
//                           <span className="text-sm text-gray-700">No</span>
...
//         {/* Save Button for Both Tables */}
//         <div className="flex justify-end">
//           <button 
//             onClick={handleSave}
//             className="px-8 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors font-medium text-lg shadow-md"
//           >
//             Save All
//           </button>
//         </div>
...
//         'https://lims.kailtech.in/api/observationsetting/update-observation-setting',
//         payload,
//         {
//           headers: {
//             Authorization: `Bearer ${authToken}`,
...
//         setRows1(table1Data.length > 0 ? table1Data : [createEmptyRow1(1)]);
//         setRows2(table2Data.length > 0 ? table2Data : [createEmptyRow2(1)]);
//         setRows3([createEmptyRow3(1)]); // Initialize with one empty row
//       } else {
//         // No data → show 1 empty row each
//         setRows1([createEmptyRow1(1)]);
//         setRows2([createEmptyRow2(1)]);
...
//   // const addRow3 = () => {
//   //   const newId = rows3.length > 0 ? Math.max(...rows3.map(r => r.id)) + 1 : 1;
//   //   setRows3([...rows3, createEmptyRow3(newId)]);
//   // };
...
//         <div className="bg-white rounded-lg shadow-md overflow-hidden">
//           <div className="p-4 border-b border-gray-200">
//             <h1 className="text-2xl font-bold text-gray-800">Additional Configuration</h1>
//           </div>
...
//       const authToken = localStorage.getItem('authToken');
//       const response = await axios.get(
//         'https://lims.kailtech.in/api/master/list-lab',
//         {
//           headers: {
//             Authorization: `Bearer ${authToken}`,
//             'Content-Type': 'application/json',
