    ...
    childs: [
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/electro-technical?labId=1'),
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/site-calibration?labId=2'),
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/calibration?labId=6'),
            title: 'Calibration',
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/chemical?labId=8'),
            title: 'Chemical',
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/building-material?labId=9'),
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/reporting?labId=18'),
            title: 'Reporting',
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/calibration-mechanical?labId=20'),
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/calibration-biomedical?labId=21'),
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/quality-department?labId=23'),
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/store-department?labId=24'),
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/mechanical?labId=10'),
            title: 'Mechanical',
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/plastic?labId=11'),
            title: 'Plastic',
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/electronics-vibration?labId=12'),
        ...
        },
        {
            id: 'dashboards.field',
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/field?labId=13'),
            title: 'Field',
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/sampling?labId=17'),
            title: 'Sampling',
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/electronics-thermal?labId=30'),
        ...
        },
        {
            ...
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/hvac-validation?labId=31'),
        ...
        },
        {
            id: 'dashboards.oes',
            type: NAV_TYPE_ITEM,
            path: path(ROOT_DASHBOARDS, '/material-list/oes?labId=46'),
            title: 'OES',
